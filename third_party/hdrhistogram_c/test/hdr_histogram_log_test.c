...
static char* writes_and_reads_log()
{
    ...
    const char* file_name = "/tmp/histogram.log";
...
static char* log_reader_fails_with_incorrect_version()
{
    ...
    const char* file_name = "/tmp/histogram_with_invalid_version.log";
    struct hdr_log_reader reader;
    FILE* log_file;
    int r;
...
{
    const char* v1_log = "third_party/hdrhistogram_c/test/jHiccup-2.0.6.logV1.hlog";
...
static char* decode_v2_log()
{
    ...
    const char* v2_log = "third_party/hdrhistogram_c/test/jHiccup-2.0.7S.logV2.hlog";
...
static char* decode_v3_log()
{
    ...
    const char* v3_log = "third_party/hdrhistogram_c/test/jHiccup-2.0.7S.logV3.hlog";
...
{
    struct hdr_histogram* accum;
    const char* v1_log = "third_party/hdrhistogram_c/test/jHiccup-2.0.1.logV0.hlog";
    struct hdr_histogram* h = NULL;
    struct hdr_log_reader reader;
    hdr_timespec timestamp;
    hdr_timespec interval;
